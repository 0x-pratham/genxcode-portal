...
export default function Login() {
  ...
  return (
    // ❗ no bg-[#0F172A] – BackgroundOrbs provides the background
      ...
      <div className="container-page max-w-5xl mx-auto w-full pt-20 md:pt-24 relative z-10">
        <div className="grid gap-10 md:gap-12 md:grid-cols-[1.1fr,1fr] items-center">
          ...
          >
            ...
            <div className="space-y-3">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight leading-tight">
                Welcome back,
                <span className="block bg-gradient-to-r from-cyan-300 via-indigo-400 to-indigo-400 bg-clip-text text-transparent">
                  let&apos;s keep building.
                </span>
              </h1>
          ...
          >
            ...
            <motion.div
              className="relative rounded-3xl bg-[#0F172A]/90 border border-slate-700/80 px-6 py-6 md:px-7 md:py-7 shadow-2xl shadow-slate-950/80 backdrop-blur space-y-5"
            ...
            >
              ...
              >
                <div className="space-y-1 relative">
                  ...
                  <span className="absolute left-3 top-8 text-slate-300">📧</span>
                  <input
                    ref={emailRef}
                    type="email"
                ...
                <div className="space-y-1 relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-7 text-xs text-slate-300 hover:text-slate-100"
                ...
                <div className="flex justify-end pt-2">
                  ...
                  >
                    ...
                    <span className="pointer-events-none absolute inset-0 bg-gradient-to-r from-cyan-400/30 via-indigo-500/30 to-indigo-500/30 opacity-0 group-hover:opacity-100 transition" />
                  </motion.button>
                </div>
              </form>
            </motion.div>
