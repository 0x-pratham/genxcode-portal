  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <motion.article
          className="relative overflow-hidden rounded-2xl border border-fuchsia-500/20 bg-slate-900/90 px-5 py-5 shadow-lg shadow-slate-950/50"
        ...
        >
          ...
          <p className="text-[11px] text-slate-300 mb-3">{founder.role}</p>
          <p className="text-sm md:text-base text-slate-100 mb-3">&quot;{founder.quote}&quot;</p>
        ...
        >
          ...
          <p className="text-[11px] text-slate-300 mb-3">{coFounder.role}</p>
          <p className="text-sm md:text-base text-slate-100">&quot;{coFounder.quote}&quot;</p>
        ...
        >
          ...
          <p className="text-[11px] text-slate-300 mb-3">{mentor.role}</p>
          <p className="text-sm md:text-base text-slate-100">&quot;{mentor.quote}&quot;</p>
          <ul className="space-y-1.5 text-[11px] md:text-xs text-slate-300 mt-3">
